    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <img
            ...
            alt={user.full_name || 'Keerthana H M'}
            style={{
              width: '90px',
              height: '90px',
              borderRadius: '50%',
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '18px', marginTop: '8px', color: 'var(--text-secondary)', fontSize: '0.86rem', flexWrap: 'wrap' }}>
      ...
      {activeTab === 'overview' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          ...
          >
            <div>
              <h3 style={{ fontSize: '1.05rem', fontWeight: 700, marginBottom: '8px', color: 'var(--neutral-800)' }}>
                Continue Contributing
              </h3>
              <p style={{ fontSize: '0.85rem', color: 'var(--neutral-500)', lineHeight: 1.4 }}>
                Help us reach 1,000 validated dataset images this week to unlock the next community milestone reward tier.
              </p>
            </div>
